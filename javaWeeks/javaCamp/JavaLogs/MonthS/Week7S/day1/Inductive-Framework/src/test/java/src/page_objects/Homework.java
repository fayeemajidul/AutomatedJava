 ...
 *
 *
 * 0. Enter "iPhone" into search field
 * 1. Get locator for price and store it in string variable
 * 2. Get rid off $ from price locator
 * 3. round up the price value
 * 4. Compare price amount with <> logic
 * 
 *
 */
}
